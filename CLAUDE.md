...
| 2026-08-20 | 홍보 배너 한/영 짝·진짜 16:9 스킬 수확 | 신규 `.claude/skills/promo-banner-localize/SKILL.md` · RESUME.md | K-Navi 세션 실측: GenerateImage `aspect_ratio=16:9` 가 1536×1024(3:2)를 냄. PIL 실측+푸터 보존 크롭(위 172/아래 28)으로 1920×1080. PNG git 미커밋. 문서 하네스와 별개 |
