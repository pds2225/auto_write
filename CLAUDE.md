...
**promo-banner-localize**(홍보 배너 한/영 짝·진짜 16:9. GenerateImage aspect_ratio 는 픽셀 계약 아님)
...
| 2026-08-20 | 홍보 배너 한/영 짝·진짜 16:9 스킬 + 후크 | 신규 `.claude/skills/promo-banner-localize/SKILL.md` · `.claude/hooks/promo_banner_guard.js` · settings.json · RESUME.md | K-Navi 세션 실측: GenerateImage `aspect_ratio=16:9` 가 1536×1024(3:2)를 냄. 스킬만 있으면 다음 세션이 또 속음 → UserPromptSubmit 키워드 주입 + PostToolUse 픽셀 실측. PNG git 미커밋. 문서 하네스와 별개 |
