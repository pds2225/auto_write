...
def test_is_obvious_placeholder_vectors() -> None:
    ...
    preserve = ["", "경기도 성남시", "서울시 강남구", "2025.03.17", "2025년 03월17일",
                ...
                "㈜OOO컴퍼니", "홍길동",
                # 영문 실단어가 한 문장에 2회 이상 나와도 가이드로 오판하면 안 된다
                # (OO 뒤 한글 조건이 빠지면 실값이 통째로 덮어쓰기됨)
                "GOOGLE 지도와 GOOGLE 검색을 연동",
                "COOKOO 브랜드와 BOOKOO 제품 비교",
                "SOHO 사무실과 SOHO 창업 지원 서비스",
                "O2O 플랫폼 기반 O2O 서비스 확장",
