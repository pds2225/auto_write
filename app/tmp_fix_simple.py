...
print(f'\nL012 "uc791uc131": {c5.count(chr(0x791)+chr(0x131)+" "+chr(0x608)+chr(0x2dc))}')
print(f'L013 ClickHere: {c5.count("Clickhere")}')
print(f'L013 HelpState: {c5.count("HelpState")}')
print(f'Content "3ucc28": {c5.count(chr(0x3)+chr(0xcc28))}')
print(f'Content "ill-fitting": {c5.count("ill-fitting")}')
