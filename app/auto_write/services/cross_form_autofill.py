...
from .source_pool_utils import (
    ...
    SourcePickScore,
    SourcePickReport,
    _parse_yyyymmdd_from_name,
    _score_resume_filename,
    _score_source_candidate,
    _source_sort_key,
    _DEFAULT_SOURCE_KEYWORDS,
    _RESUME_BONUS_KEYWORD,
    _RESUME_PENALTY_KEYWORDS,
)
...
# list_source_pool, rank_source_pool, SourcePickScore, SourcePickReport 등은
# source_pool_utils.py에서 import됨 (CORE 유틸리티)
...
# list_source_pool, rank_source_pool, SourcePickScore, SourcePickReport 등은
# source_pool_utils.py에서 import됨 (CORE 유틸리티)
# 아래 rank_source_pool은 BIZPLAN 전용 오버라이드 (dry_run_transcribe_score 사용)
...
def rank_source_pool(
    ...
    *,
    ...
    BIZPLAN 전용: dry_run_transcribe_score를 사용한 실전 시뮬레이션 포함.
    """
