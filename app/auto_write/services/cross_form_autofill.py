...
SYNONYMS: list[list[str]] = [
    ...
    ["대표자", "성명", "대표", "대표이사", "대표자명", "대표자성명",
     "성명(대표자)", "신청인",
     # 2026-07-01 확장: 신청자명↔성명 미매칭(실측) 해소. 이름값 가드가 오전사 차단.
    ...
    ["주소", "소재지", "사업장주소", "사업장소재지", "주된사무소소재지",
     "본사주소", "회사주소",
     # 2026-07-01 확장: 주소지↔자택주소 미매칭(실측) 해소. 한 양식에 2칸이면 conflict 로 자동전사 보류.
    ...
    ["직위", "직급", "직책",
     # 2026-07-01 확장: 슬래시는 _key 에서 유지되므로 슬래시 포함 라벨을 그대로 추가
